...
<body>
  ...
  } else if ($cat == 'Recycled Books') {
    $image = "recycled_books.jpeg";
    $p = "Buy recycled books for effective practice instead of using new books. Contribute to sustainability by choosing recycled options. Join Eco-Scrap Exchange and find your next favorite read!";
  }
  ...
  <div class="container" id="about">
    ...
    <div class="row">
      ...
      <div class="col-sm-6">
        ...
        <br>
        <a href="sell-details.php?cat=Recycled-papers" data-toggle="modal" data-target="#purchaseModal"
          class="btn btn-success"><img src="images/icon.png" class="icon"> Request For Purchase</a>
      </div>
    </div>
  </div>
