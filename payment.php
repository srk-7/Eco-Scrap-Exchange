    ...
    <div class="flex-fill flex-vertical">
      ...
      <div class="card-data flex-fill flex-vertical">
        ...
        <div class="flex-between">
          <div class="card-number flex-vertical-center flex-fill">
            <div class="card-number-field flex-vertical-center flex-fill">
              ...
              <input required class="numbers" type="number" placeholder="0000">-
              <input required class="numbers" type="number" placeholder="0000" data-bound="carddigits_mock"
                data-def="0000">
            </div>
        ...
        <div class="flex-between">
          ...
          <div class="card-property-value flex-vertical-center">
            <div class="input-container half-width">
              <input required class="numbers" data-bound="mm_mock" data-def="00" type="number" min="1" max="12" step="1"
                placeholder="MM" maxlength="2">
            </div>
            <span class="m-md">/</span>
            <div class="input-container half-width">
              <input required class="numbers" data-bound="yy_mock" data-def="01" type="number" min="23" max="99"
                step="1" placeholder="YY">
            </div>
          </div>
        </div>
        ...
        <div class="flex-between">
          ...
          <div class="card-property-value">
            <div class="input-container">
              <input required id="name" data-bound="name_mock" data-def="Mr. Cardholder" type="text" class="uppercase"
