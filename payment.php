...
<div class="screen flex-center">
  <form class="popup flex p-lg" action="success.php">
      ...
      <div class="flex-fill flex-vertical">
        <div class="header flex-between flex-vertical-center">
          <div class="flex-vertical-center">
            ...
            <span class="title">
              <strong>Eco-Scrap</strong><span>Exchange</span>
            </span>
          </div>
...
<svg xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 48 48" width="24px" height="24px"><path fill="#ff9800" d="M32 10A14 14 0 1 0 32 38A14 14 0 1 0 32 10Z"/><path fill="#d50000" d="M16 10A14 14 0 1 0 16 38A14 14 0 1 0 16 10Z"/><path fill="#ff3d00" d="M18,24c0,4.755,2.376,8.95,6,11.48c3.624-2.53,6-6.725,6-11.48s-2.376-8.95-6-11.48 C20.376,15.05,18,19.245,18,24z"/></svg>
                ...
                <input required class="numbers" type="number" min="1" max="9999" placeholder="0000">-
                <input required class="numbers" type="number" placeholder="0000">-
                <input required class="numbers" type="number" placeholder="0000">-
                <input required class="numbers" type="number" placeholder="0000" data-bound="carddigits_mock" data-def="0000">
              </div>
          ...
          <div class="flex-between">
            ...
            <div class="card-property-value flex-vertical-center">
              <div class="input-container half-width">
                <input required class="numbers" data-bound="mm_mock" data-def="00" type="number" min="1" max="12" step="1" placeholder="MM" maxlength="2">  
              </div>
              <span class="m-md">/</span>
              <div class="input-container half-width">
                <input required class="numbers" data-bound="yy_mock" data-def="01" type="number" min="23" max="99" step="1" placeholder="YY">
              </div>
            </div>
          </div>
          ...
          <div class="flex-between">
            ...
            <div class="card-property-value">
              <div class="input-container">
                <input required id="name" data-bound="name_mock" data-def="Mr. Cardholder" type="text" class="uppercase" placeholder="CARDHOLDER NAME">
                <i class="ai-person"></i>
              </div>
            </div>
          </div>
        ...
        <div class="action flex-center">
           <button  type="submit" class="b-main-color">Pay Now</button>
        </div>
      </div>
      ...
      <div class="sidebar flex-vertical">
        ...
        <div class="purchase-section flex-fill flex-vertical">
          ...
          <ul class="purchase-props">
            <li class="flex-between">
              <span>Company</span>
              <strong>Eco-Scrap Exchange</strong>
            </li>
            <li class="flex-between">
              <span>Order number</span>
              <strong><?= (rand(1111111,999999))?></strong>
            </li>
            <li class="flex-between">
              <span>Product</span>
              <strong><?= $_GET['cat'];?></strong>
            </li>
        ...
        <div class="total-section flex-between flex-vertical-center">
          <div class="flex-fill flex-vertical">
            ...
            <div>
              <strong><?= (rand(111,999))?></strong>
              <small>.99 <span class="f-secondary-color">INR</span></small>
            </div>
          </div>
