 ...
 <div class="container-fluid" id="Services" style="padding-bottom:35px;padding-top: 35px;padding:25px">
     ...
     <div class="row">
          ...
          <div class="col-sm-4">
            ...
            <center><a href="sell-details.php?cat=Recycled-papers&p=20"   class="btn btn-danger"><img src="images/icon.png" class="icon"> Request For Purchase</a></center>
         </div>
          ...
          <div class="col-sm-4">
            ...
            <center><a href="sell-details.php?cat=Cardboard&p=30"   class="btn btn-danger"><img src="images/icon.png" class="icon"> Request For Purchase</a></center>
         </div>
         ...
         <div class="col-sm-4">
            ...
            <center><a href="sell-details.php?cat=Novels&p=40"  class="btn btn-danger"><img src="images/icon.png" class="icon"> Request For Purchase</a></center>
         </div>
